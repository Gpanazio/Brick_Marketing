...
const MARKETING_MODELS = {
    VALIDATOR:    { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    AUDIENCE:     { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    RESEARCH:     { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    CLAIMS:       { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    COPY_A:       { primary: { provider: 'openrouter', model: 'openai/gpt-5.1' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    COPY_B:       { primary: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    COPY_C:       { primary: { provider: 'openrouter', model: 'anthropic/claude-sonnet-4.5' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
...
const PROJETOS_MODELS = {
    BRAND_DIGEST:      { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    CREATIVE_A:        { primary: { provider: 'openrouter', model: 'openai/gpt-5.1' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    CREATIVE_B:        { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    CREATIVE_C:        { primary: { provider: 'openrouter', model: 'anthropic/claude-sonnet-4.5' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    CONCEPT_CRITIC:    { primary: { provider: 'google', model: 'gemini-3-pro-preview' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    EXECUTION_DESIGN:  { primary: { provider: 'openrouter', model: 'anthropic/claude-opus-4.6' }, fallback: { provider: 'openrouter', model: 'openai/gpt-5.1' } },
    PROPOSAL:          { primary: { provider: 'openrouter', model: 'openai/gpt-5.1' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    DIRECTOR:          { primary: { provider: 'google', model: 'gemini-3-pro-preview' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } }
};
...
const ORIGINAIS_MODELS = {
    TRIAGE:          { primary: { provider: 'google', model: 'gemini-2.0-flash' }, fallback: { provider: 'openrouter', model: 'deepseek/deepseek-v3.2' } },
    ...
    SALES_SHARK:     { primary: { provider: 'openrouter', model: 'x-ai/grok-4.1-fast' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    ANGEL:           { primary: { provider: 'openrouter', model: 'anthropic/claude-sonnet-4.5' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    ...
    async callWithRetry(systemPrompt, userPrompt, options = {}) {
        ...
        for (let attempt = 1; attempt <= maxRetries; attempt++) {
            ...
            try {
                ...
                const response = await client.callAgent(systemPrompt, userPrompt, model);
