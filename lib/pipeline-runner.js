...
class PipelineRunner {
    ...
    async run(briefingContent) {
        ...
        // Acender node DOUGLAS (orquestrador) - gerar PROCESSED.md
        this.saveFile(`${this.jobId}_PROCESSED.md`, `# Processado pelo Pipeline Autônomo\n\n${briefingContent}\n\n**Modelo:** ${this.model}\n**Timestamp:** ${new Date().toISOString()}`);
        this.emitProgress('DOUGLAS', 'completed');
