...
const PROJETOS_MODELS = {
    ...
    CONCEPT_CRITIC:    { primary: { provider: 'openrouter', model: 'google/gemini-3-pro-preview' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } },
    ...
    DIRECTOR:          { primary: { provider: 'openrouter', model: 'google/gemini-3-pro-preview' }, fallback: { provider: 'google', model: 'gemini-2.0-flash' } }
};
...
class PipelineRunner {
    ...
    async callWithRetry(systemPrompt, userPrompt, options = {}) {
        ...
        const MODEL_MAP = { ideias: IDEIAS_MODELS, marketing: MARKETING_MODELS, projetos: PROJETOS_MODELS };
    ...
    async runOriginais(briefingContent) {
        ...
        this.emitProgress('CREATIVE_DOCTOR', 'running');
        this.emitProgress('SALES_SHARK', 'running');
        ...
        this.emitProgress('ANGEL', 'running');
        this.emitProgress('DEMON', 'running');
        ...
        this.emitProgress('DOCTOR_FINAL', 'running');
        try {
